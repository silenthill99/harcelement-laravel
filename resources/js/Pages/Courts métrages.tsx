        ...
        <PageStructure auth={auth.user} title={"Courts métrages"}>
            <div className={"container mx-auto p-5 md:p-4 flex flex-col justify-center gap-5"}>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-5 text-center">
                    ...
                    {/*<YoutubeVideos id="HwORszEu3ig" name="Silence toxique. Harcèlement scolaire." className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="k5aaghD6hKA" name="Une Nouvelle Chance - Harcèlement scolaire" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="ZiW08jC4P5s" name="PRIX COUP DE CŒUR : Non au harcèlement CM2 Leroy Rostand" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="gX--7YGl-iE" name="briser le silence" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="Bg9FR4IrQwk" name="Et si ça s'arrêtait" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="JT3odVY4CmU" name="Le Cercle, court métrage sur le harcèlement | Ville de Mulhouse" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="7Cs5ggjnSrk" name="CAUCHEMARS." className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="eKhJEGYC30U" name="Pourquoi t'as fait ça !?" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="WoJtIQ2B1lU" name="C'est envoyé" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="GRSxeC8F9wI" name="Et si c'était moi - prévention racket" className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id="p6-_PkQx4Yg" name={"L'école du silence"} className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id={"1q9CUZWGrcY"} name={"Courage"} className={"flex flex-col items-center"}/>*/}
                    {/*<YoutubeVideos id={"9lsbivUrTac"} name={"HARCÈLEMENT SCOLAIRE : Film dénonciateur"} className={"flex flex-col items-center"}/>*/}
